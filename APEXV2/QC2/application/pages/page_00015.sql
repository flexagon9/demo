...
,p_last_upd_yyyymmddhh24miss=>'20190429135155'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(52073529523284765)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15863845471399888)
,p_name=>'P15_WELCOME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(52073529523284765)
,p_prompt=>'New'
,p_source=>'select ''This is the Station xRef Page'' from dual'
,p_source_type=>'QUERY'
