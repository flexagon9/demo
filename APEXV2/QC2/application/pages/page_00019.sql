...
,p_last_upd_yyyymmddhh24miss=>'20190429135305'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(70379564561804267)
,p_plug_name=>'Model Maintenance'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15872710096508088)
,p_name=>'P19_WELCOME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(70379564561804267)
,p_prompt=>'New'
,p_source=>'select ''This is the Model Maintenance Page'' from dual'
,p_source_type=>'QUERY'
