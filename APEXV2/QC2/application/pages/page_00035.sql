...
'',
''))
,p_step_template=>wwv_flow_api.id(90702242913242390)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23767798750474018)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24418879506024302)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24419184562024305)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(24723406782905095)
,p_name=>'Available Images to ADD'
,p_parent_plug_id=>wwv_flow_api.id(24419184562024305)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(24723464315905096)
,p_query_column_id=>1
,p_column_alias=>'BOX'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(24723581183905097)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(24723672952905098)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(24723827785905099)
,p_query_column_id=>4
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(33624366482364470)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(35457145136105639)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(24419911002024312)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24722878061905090)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24420283160024316)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24723094420905092)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24723218380905093)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24722949772905091)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(24709867374348254)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23768915080474021)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(24418879506024302)
,p_button_name=>'BACK'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23785264625484987)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23768301239474020)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24419281469024306)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(24723406782905095)
,p_button_name=>'Add'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23771297784474026)
,p_name=>'P35_IMAGES_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23771675483474031)
,p_name=>'P35_PLANT_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23772079354474038)
,p_name=>'P35_MODEL_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
,p_prompt=>'Model'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23772456854474038)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23772868427474039)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23773256086474039)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23773687719474039)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23774111111474040)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23774545432474040)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23774877964474040)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23775656249474041)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23785219653484986)
,p_name=>'P35_YEAR'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
,p_prompt=>'Model Year'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23785396620484988)
,p_name=>'P35_MODEL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23791075937497827)
,p_name=>'P35_LAST_UPDATE_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(33624366482364470)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23791530533497830)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23791944894497830)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23792336232497831)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23795765240529119)
,p_name=>'P35_PLANT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23825308397059133)
,p_name=>'P35_STATUS'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24849239739048974)
,p_name=>'P35_BRAND_ID'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(23767798750474018)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25266570910050748)
,p_name=>'P35_COLLASPE_EXPAND_FLAG'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(35457145136105639)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(23769010455474021)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(23768915080474021)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23769808182474023)
,p_event_id=>wwv_flow_api.id(23769010455474021)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(24800496354601291)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(24800596937601292)
,p_event_id=>wwv_flow_api.id(24800496354601291)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(35457145136105639)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(24800667878601293)
,p_event_id=>wwv_flow_api.id(24800496354601291)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(24723406782905095)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(25264693532040149)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(25265562069040151)
,p_event_id=>wwv_flow_api.id(25264693532040149)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(25265092753040151)
,p_event_id=>wwv_flow_api.id(25264693532040149)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24800402832601290)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23778090395474047)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24668273069575735)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(24419281469024306)
,p_process_success_message=>'Image added to selected model(s).'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24801994646601306)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23779692297474049)
,p_process_sequence=>80
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(23768915080474021)
);
end;
/
