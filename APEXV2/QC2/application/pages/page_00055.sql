...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(36617655657754430)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(53937320468686020)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(62507300876711028)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13145230976026622)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(36617655657754430)
,p_button_name=>'Back'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13146440055026624)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13145624863026623)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13146063025026623)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13147194612026625)
,p_name=>'P55_QCIS_DIVISION_MASTER_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(53937320468686020)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13147524636026627)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13148355061026628)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13148766269026629)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13149536731026631)
,p_name=>'P55_STATUS'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(53937320468686020)
,p_prompt=>'Status:'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13150692250026632)
,p_name=>'P55_LAST_UPDATE_DATE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(62507300876711028)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13151020471026633)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13151406951026633)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13151891870026633)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(13153875870026638)
...
,p_associated_item=>wwv_flow_api.id(13148355061026628)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(13156126610026642)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(13145230976026622)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(13156617726026643)
,p_event_id=>wwv_flow_api.id(13156126610026642)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13154900176026640)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13155369601026641)
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(13146063025026623)
,p_process_success_message=>'Division successfully created'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13155711541026642)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(13145624863026623)
,p_process_success_message=>'Changes successfully applied'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14361087794166789)
